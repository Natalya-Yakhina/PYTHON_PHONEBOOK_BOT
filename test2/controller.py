...
LASTNAME, NAME, NUM, SEARCH, END_SEARCH, DELETE_ALL, DEL_CONT, DEl_C, EDIT, EDITOR, EDIT_SURNAME, EDIT_NAME, EDIT_TEL, EDIT_COMMENT= range(14) # константы этапов разговоров 
